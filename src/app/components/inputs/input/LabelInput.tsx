		...
		<div className="w-full ct-flex-start py-6">
			<label className="w-full relative cursor-pointer">
				<input
					type="text"
					placeholder="Input"
					className="h-12 w-full px-[10px] text-sm text-black border-gray-500 border rounded border-opacity-50 outline-none focus:border-sky-600 placeholder-gray-300 placeholder-opacity-0 transition duration-200"
				/>
